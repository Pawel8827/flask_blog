...
var poczatek = "Dzisiaj jest " + dzien + " " + miesiace[miesiac] + " " + rok + " Imieniny: ";
// Tekst wyswietlany przed lista imienin
var textt = (poczatek + imieniny[miesiac][dzien]);
// wyswietlenie rezultatu na stronie

document.getElementById('imieniny').innerHTML = textt;
return 0;
}
...
$('#myCarousel').on('slid.bs.carousel', function (e) {
    ...
    //var carouselData = $(this).data('.active').attr('id');
    var currentIndex = $e.index() +1;
    $('.nums').html('' + currentIndex + '/' + totalItems + '');
    //var duration = $(this).find('.active img').attr('id');
    
    if (document.querySelector('.carousel-item.active video')) {
        vid1 = document.querySelector('.carousel-item.active video')
        vid1.currentTime = 0;
        vid1.play();
    }
   ...
   // } else {
        ...
        //vid1.onended = function() { $("#myCarousel").carousel();
     //   var time= (document.getElementById(currentIndex).getElementsByTagName('video').item(0).duration)*1000
        //var carouselData = $(this).find('.active').attr('data-interval', time);
      //  var carouselData = $(this).find('.active').setAttribute("data-interval", time);
      //  var vid1 = $(this).find('.active').find('video')[0]
      //  console.log(time)
      //  vid1.currentTime = 0;
   ...
   // }
    ...
    //var cde= document.getElementById(id).getElementsByTagName('img')[0].src
    //var abc= document.getElementById(id).getElementsByTagName('video').item(0).duration
   // var abc= document.getElementsByClassName('carousel-item active')[0].getElementsByTagName('img').item(0)
  });
